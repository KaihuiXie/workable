...
def get_match_prompt(html=None, user_info=None):
    return match_prompt.format(html=html, user_info=user_info) + match_output_sample

def get_resume_prompt(resume):
    return resume_prompt + resume_input_prompt.format(resume=resume)

if __name__ == '__main__':
    print(get_match_prompt(html='html', user_info='ifo'))