...
2. Verify the answer to make sure it answers the question and answer. If the answer can not solve the question, find the correct answer.
3, DO NOT mention you have been provided with some inputs.
4. If there are no exact answer or even no answer to the question in <response>, generate your own answer to solve the question.
